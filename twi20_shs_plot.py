...
# Build graph from TwiBot20 and run Louvain
G_eg = _build_eg_from_csv('/NVMeDATA/gxj_data/hyperscan_cikm25/twibot20/edge_index.csv')
...
labels = _load_labels_pt('/NVMeDATA/gxj_data/hyperscan_cikm25/twibot20/label.pt')
def _node_color(n):
    try:
...
# 保存为 PDF 和 PNG 图片
plt.savefig('figs/twi20_shs.pdf')
